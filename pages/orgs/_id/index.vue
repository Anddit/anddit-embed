    ...
    <section class="flex">
      <div class="w-full mx-auto">
        <div class="md:w-1/2 md:float-left md:mt-4">
          ...
          <!-- {{message}} -->
          <div class="mx-auto md:w-4/5 md:mt-6 md:float-right bg-white  border rounded border-grey-lighter-2 relative">
            <div class="w-full mx-auto justify-center rounded overflow-hidden items-center">
              ...
              <div class="flex text-left px-2 py-3 ml-3 lg:mt-3">
                <div>
                  <p v-if="org.activestatus" class="bestknown hpapproved text-xs uppercase text-blue-lighter mt-2 mb-2">
                    HOPE PORTAL: APPROVED
                  </p>
                  <div v-else class="mb-3">
                    <a class="bg-purple-lighter bestknown uppercase text-purple-darker text-xs mb-2 px-2 rounded hover-none py-2"> HOPE PORTAL: PENDING APPROVAL</a>
                  </div>
                  <p
                    class="orgtitle leading-none mt-1 font-bold text-2xl text-grey-darkest "
                  >
                    {{ org.title }}
                  </p>
                </div>
